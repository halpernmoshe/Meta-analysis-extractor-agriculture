...
def load_loladze():
    ...
    """
    json_path = BASE_DIR / 'output' / 'loladze_agent_replication' / 'validation_llm_10pp.json'
...
def load_hui():
    ...
    """
    improved = BASE_DIR / 'output' / 'hui2023_full_35' / 'validation_matches_improved.csv'
    original = BASE_DIR / 'output' / 'hui2023_full_35' / 'validation_matches.csv'
    ...
    if improved.exists():
        ...
        return None, "Hui CSV not found in output/hui2023_full_35/"
...
def load_li2022():
    ...
    """
    csv_path = BASE_DIR / 'output' / 'li2022_combined' / 'validation_matches_effect_first.csv'
...
def load_biochar():
    ...
    """
    val_path = BASE_DIR / 'output' / 'biochar_extraction' / 'validation_results.json'
...
def load_boldorini():
    ...
    """
    gt_path = BASE_DIR / 'data' / 'boldorini_gt.csv'
    ext_dir = BASE_DIR / 'output' / 'boldorini_extraction'
